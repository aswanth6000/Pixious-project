...
insert  into `bugs`(`bugs_id`,`sender_id`,`date`,`bug_heading`,`bug_description`,`type`,`reply_date`,`reply`) values (1,2,NULL,'gjhn','jnk','type','0000-00-00','');
...
insert  into `feedback`(`feedback_id`,`sender_id`,`feedback`,`date`,`reply`,`reply_date`,`type`) values (1,100,'abcd',NULL,'xdgd','0000-00-00',NULL);
...
insert  into `movie`(`movie_id`,`movie_name`,`description`,`creator_id`,`director_name`,`movie`,`movie_status`) values (100,'ddd','dd',2,'director','movie','approved'),(101,'mm','we',2,'director','ed','rejected');
...
insert  into `user`(`user_id`,`name`,`email`,`phone`,`photo`,`user_status`) values (2,'dfcg','a@gmail.com',6262,NULL,NULL),(100,'abcd','b@gmail.com',2345,NULL,NULL);
